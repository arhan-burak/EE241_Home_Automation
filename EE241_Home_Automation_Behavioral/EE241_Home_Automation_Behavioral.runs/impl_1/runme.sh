...
HD_PWD='C:/Users/arhan/jghf/EE241_Home_Automation_Behavioral/EE241_Home_Automation_Behavioral.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log home_automation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source home_automation.tcl -notrace
