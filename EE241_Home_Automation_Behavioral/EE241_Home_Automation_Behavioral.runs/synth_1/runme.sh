...
HD_PWD='C:/Users/arhan/jghf/EE241_Home_Automation_Behavioral/EE241_Home_Automation_Behavioral.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log home_automation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source home_automation.tcl
